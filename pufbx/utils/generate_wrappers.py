...
def generate_wrapper_files():
    output_dir = "pufbx/generated"
    os.makedirs(output_dir, exist_ok=True)

    # Load pxd to check pointer depth
    pxd_source_path = "pufbx/pufbx.pxd"
    ...
    with open(pxd_path, "w") as f:
        ...
        f.write(f"from pufbx.pufbx cimport {imported_types}\n")
        for class_name, _, _, parent in WRAPPER_TYPES:
            f.write(f"from pufbx.{parent} cimport {class_name}\n")
        f.write("\n")
